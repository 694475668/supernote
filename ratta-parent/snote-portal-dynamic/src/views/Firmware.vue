    ...
    <div id="firmware">
        <div class="banner flex" :style="{ marginBottom: width===750? getSize(60) : getSize(80)}">
            ...
            <div style="position: absolute">
                <span class="searchTitle bold" :style="{fontSize: getSize(36),}">{{$t('message.service.firm.listTitle')}}</span>
            </div>
        </div>
        <section :style="{paddingLeft: width===750?getSize(50):'13%',paddingRight: width===750?getSize(50):'13%',}">
            <div v-if="width>750" v-for="item in $store.state.firmware" class="downloadItem"
                ...
                <div>
                    ...
                    <div class="ql-snow ql-editor" :style="{height: 'auto', fontSize: getSize(14), width: getSize(755), marginBottom: getSize(30)}"
            ...
            <div class="list-mobile" v-if="width===750">
                <div v-for="item in $store.state.firmware"
                     :style="{ paddingBottom: getSize(40), marginBottom: getSize(40), borderBottom: '1px solid #DBDBDB'}">
                    <div style="display: flex;width: 100%">
                        <div :style="{width: getSize(160), height: getSize(180), overflow: 'hidden', marginRight: getSize(20)}">
                            <img width="100%" :src="item.thumbnailUrl" alt="">
                        </div>
                        <div :style="{width: getSize(400)}">
                            ...
                            <div :style="{fontSize: getSize(24), color: '#777777', marginBottom: getSize(30)}"
                                 v-html="item.description"><span>{{item.description}}</span>
                            </div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.$store.dispatch('seoAll', {language: localStorage.getItem("language") === 'zh-CN' ? 'zh-CN' : 'en', pageSerial: '6'})
