...
export function getUsermess(data) {
    return request({
        url: 'system/cms/base/manage/user/role',
        method: 'post',
        headers: {
...
export function addUsermess(data) {
    return request({
        url: 'system/cms/base/manage/user/add',
        method: 'post',
        data,
        headers: {
            "x-access-token": window.localStorage.getItem('token')
...
export function authorUsermess(data) {
    return request({
        url: 'system/cms/base/manage/user/grant',
        method: 'post',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        },
...
export function startUsermess(data) {
    return request({
        url: 'system/cms/base/manage/user/open',
        method: 'put',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        },
...
export function closeUsermess(data) {
    return request({
        url: 'system/cms/base/manage/user/close',
        method: 'put',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        },
...
export function amendUsermess(id, data) {
    return request({
        url: 'system/cms/base/manage/user/' + id,
        method: 'put',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        },
...
export function unblockUsermess(id) {
    return request({
        url: 'system/cms/base/manage/user/unlock/' + id,
        method: 'put',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        }
...
export function unblockUser(id) {
    return request({
        url: 'system/cms/base/manage/user/erificationUnlock/' + id,
        method: 'get',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        }
...
export function getCheckuser(id) {
    return request({
        url: 'system/cms/base/manage/user/role/' + id,
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        },
        method: 'get'
...
export function pasdUsermess(data) {
    return request({
        url: 'system/cms/base/manage/user',
        method: 'put',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        },
...
export function amendPasw(data) {
    return request({
        url: 'system/cms/base/manage/user/pwd',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        },
        method: 'put',
...
export function checkOldPwd(data) {
    return request({
        url: 'system/cms/base/manage/user/check',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        },
        method: 'post',
...
export function verifvPassword() {
    return request({
        url: 'system/cms/base/manage/user/verifvPassword',
        headers: {
            "x-access-token": window.localStorage.getItem('token')
        },
        method: 'get'
