    ...
    >
      <div class="commont">
        <el-form-item label="序号" :label-width="formLabelWidth">
          <el-input v-model="addblog.seq" autocomplete="off" maxlength="9"></el-input>
        </el-form-item>
      ...
      <div class="commont">
        <el-form-item label="pc图片(420*280)" :label-width="formLabelWidth">
          <el-upload
        ...
        <el-form-item label="移动端图片(650*433)" :label-width="formLabelWidth">
          <el-upload
            class="avatar-uploader"
            action="https://jsonplaceholder.typicode.com/posts/"
            :show-file-list="false"
