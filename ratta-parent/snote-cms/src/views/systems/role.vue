...
export default {
  ...
  methods: {
    ...
    search() {
      this.currentPage = 1;
      this.params.pageNo = 1;
      this.params.roleName = this.param.roleName;
      this.getList();
    },
    ...
    accreditCheck() {
      ...
      if (this.arr1.length > 0 && this.arr2.length > 0) {
        this.arr = (this.arr1.toString() + "," + this.arr2.toString()).split(
          ","
        );
