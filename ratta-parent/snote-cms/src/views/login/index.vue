<template>
  <div class="login-container">
    <div class="login">
      <div class="word" :style="{position: 'absolute', top: '300px', left: '13%', textAlign: 'left', color: '#ffffff'}">
  <div  :style="{fontSize: '64px'}">
    <span>随时 随地 随意</span>
  </div>
    <div :style="{fontSize: '32px', marginTop: '24px'}">
         <span>自由自在，享受创作的乐趣</span>
    </div>
</div>
    <el-form
      ref="loginForm"
    ...
    >
      ...
      <el-button
        :loading="loading"
        type="primary"
        style="width:100%;margin-bottom:30px;height:52px;font-size:18px;"
...
.login-container {
  ...
  .title-container {
    ...
    .title {
      font-size: 26px;
      color: #fff;
      text-shadow: 1px 1px 7px #8e8e8e;
...
@media screen and (max-width:768px){
  .login-container{
     background: url("../../assets/img/banner.png") no-repeat center center!important;
  ...
  .logo{
      text-align:center;
      background:url("../../assets/img/logo1.png") no-repeat center center!important;
      width: 100%;
      height: 97px;
  }
}
.login .el-input input:-webkit-autofill{
