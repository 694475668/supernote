  ...
  <div class="addpro">
    <div class="addhead">
      <el-form
        ...
        class="form"
      >
            <el-form-item label="产品型号" :label-width="formLabelWidth" porp="type">
              <el-select v-model="form.type" disabled placeholder="请选择" style="width:100%">
                <el-option
           ...
           <div class="commont">
            ...
            <el-form-item label="详情名称EN" :label-width="formLabelWidth" prop="titleEn">
              <el-input v-model="form.titleEn" autocomplete="off" maxlength="255" type="text"></el-input>
            </el-form-item>
           </div>
...
<script>
import quill from "../common/quill.vue";
import { uploads } from "../../api/upload.js";
import { changeBanner, getLists } from "../../api/productMess.js";
...
export default {
  ...
  mounted() {
    ...
    getLists({
      ...
      this.form.descriptionMobileCn = item.descriptionMobileCn;
      this.form.descriptionMobileEn = item.descriptionMobileEn;
      this.form.descriptionPcCn = item.descriptionPcCn;
      this.form.descriptionPcEn = item.descriptionPcEn;
      this.form.seoTitleCn = item.seoTitleCn
      this.form.seoTitleEn = item.seoTitleEn
      ...
      this.form.titleCn = item.titleCn;
      this.form.titleEn = item.titleEn;
      this.form.type = item.type;
      this.form.seq = item.seq;
      this.imageUrl1 = item.productPictureUrl;
    });
    autotip: {
      ...
      if (
        ...
        this.$refs.form.validate(valid => {
          if (valid) {
            ...
            changeBanner(this.id, this.form).then(res => {
              if (res.success) {
