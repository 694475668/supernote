  ...
  <div class="apprepair">
    <div class="apprepair-head">
      <ul>
        ...
        <li>
          <el-button type="primary" @click="add" v-permit="'/app/fixPoint/add'">添加</el-button>
        </li>
        <li>
          <el-button type="primary" @click="edit" v-permit="'/app/fixPoint/update'">修改</el-button>
        </li>
      </ul>
    </div>
    <!-- 新增 -->
    ...
    >
      <el-form :model="data" :rules="rulesadd" ref="data" :status-icon="true" :show-message="false">
        ...
        >
          <el-select v-model="data.lan" placeholder="请选择" @focus="getLan()">
            <el-option
        ...
        >
          ...
          >
            <el-option v-for="item in appNameData" :key="item" :label="item" :value="item"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item
          v-if="data.appName!=''"
        ...
        <el-form-item :label-width="formLabelWidth" prop="fixPoint" class="updateEditor">
          <quill-editor
    ...
    <el-dialog title="修改" :visible.sync="dialogVisible" :close-on-click-modal="false">
      ...
      >
        ...
        <el-form-item
          ...
          style="padding-right:4px;padding-left:4px;"
        >
          <el-input v-model="updateData.appName" :disabled="true"></el-input>
        </el-form-item>
        <el-form-item
          label="版本号: "
          :label-width="formLabelWidth"
          ...
          style="padding-left:8px"
        >
          <el-input v-model="updateData.appVersion" :disabled="true"></el-input>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" prop="fixPoint" class="updateEditor">
          <quill-editor
    ...
    <div class="tab">
      ...
      >
        ...
        <el-table-column prop="appName" label="应用名称" width="150px"></el-table-column>
        <el-table-column prop="appVersion" label="版本号" width="150px"></el-table-column>
        ...
        <el-table-column prop="opUser" label="操作员" width="150px"></el-table-column>
...
export default {
    ...
    return {
     ...
     updateRowData: {
      ...
      rulesadd: {
        ...
        appVersion: [{ required: true, trigger: "change" }],
        fixPoint: [{ required: true, trigger: "blur" }]
      },
      editorOption: {
        modules: {
          toolbar: [
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      setTimeout(() => {
        getAppFixpointList(this.form).then(res => {
    ...
    save(formName) {
      this.$refs[formName].validate(valid => {
        ...
        if (valid) {
          this.isRepeat = true;
          this.isDisable = true;
          addAppFixpoint(this.data).then(res => {
            if (res.success) {
              this.$message({
                type: "success",
                message: "添加成功",
    ...
    edit() {
      ...
      this.updateData.appName = this.updateRowData.appName;
      this.updateData.appVersion = this.updateRowData.appVersion;
    ...
    update() {
      ...
      this.isRepeat = true;
      this.isDisable = true;
      updateAppFixpoint(this.updateData, this.id).then(res => {
    ...
    //查询app名称列表
    getFirst() {
      getAppNameList().then(res => {
        this.data.appName = "";
        this.data.appVersion = "";
        this.appNameData = res.voList;
      });
    },

    getSecond() {
      getAppVersionList({ appName: this.data.appName }).then(res => {
        this.appNameData = res.voList;
      });
    },
    ...
    getRow(row) {
      ...
      this.updateRowData.appName = row.appName;
      this.updateRowData.appVersion = row.appVersion;
